...
import logo from "../../images/אלבנה פטרובה לוגו.png";
        ...
        <div className={styles.navbarInner}>
          ...
          <button className={styles.menuButton} onClick={openForm}>
            <div className={styles.buttonContent}>
              <span className={styles.buttonText}>לחצי כאן לשיחת ייעוץ</span>
            </div>
          </button>
        </div>
      </nav>
...
/>
              ...
              <button 
                ...
                disabled={isSubmitting || submitted}
              >
                {isSubmitting ? 'שולח...' : submitted ? 'נשלח בהצלחה!' : 'אלבנה, בואי נדבר!'}
              </button>
            </form>
          </div>
        </div>
